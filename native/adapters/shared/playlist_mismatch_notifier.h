...
// (CoordinatorClient, mirroring the coordinator's own reconciliation
// verdict) rather than being fixed here, so there is exactly one place in
// this repository that could make the raise and the clear disagree, and
// it is not this file.
